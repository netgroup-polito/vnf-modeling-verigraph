package it.polito.nfdev.ipv4ToIpv6;
...
public class IpV6Access extends NetworkFunction{

	private String accessIp;
	private String exitIp;
	
	public IpV6Access(List<Interface> interfaces,  String accessIp, String exitIp) {
		super(interfaces);
