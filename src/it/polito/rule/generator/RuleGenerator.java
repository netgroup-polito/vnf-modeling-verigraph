...
public class RuleGenerator {
	...
	public void setSnapshot(ReturnSnapshot returnSnapshot) {
		...
		if (tableTypes.size() != tableSize)
			throw new RuntimeException("Error: tableSize and tableTypes.size() must be of the same size: " + tableSize
					+ " - " + tableTypes.size());
	}
	...
	public void saveRule() {
		...
		try {
			...
			marshaller.setProperty(Marshaller.JAXB_SCHEMA_LOCATION,
					"http://www.example.org/LogicalExpressions LogicalExpressions.xsd");
