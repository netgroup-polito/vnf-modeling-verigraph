 ...
 *
 */
public class Test_Classifier_Fw {
	...
	public Test_Classifier_Fw() {
		ctx = new Context();

		NetContext nctx = new NetContext(ctx, new String[] { "a", "b", "cf", "fw" },
				new String[] { "ip_a", "ip_b", "ip_cf", "ip_fw" });
		...
		rt1.add(new Tuple<DatatypeExpr, NetworkObject>(nctx.am.get("ip_fw"), cf));
		...
		rt2.add(new Tuple<DatatypeExpr, NetworkObject>(nctx.am.get("ip_b"), fw));
		...
		rt4.add(new Tuple<DatatypeExpr, NetworkObject>(nctx.am.get("ip_a"), fw));
		rt4.add(new Tuple<DatatypeExpr, NetworkObject>(nctx.am.get("ip_cf"), fw));
		rt4.add(new Tuple<DatatypeExpr, NetworkObject>(nctx.am.get("ip_fw"), fw));

		net.routingTable(b, rt4);

		net.attach(a, b, cf, fw);
	...
	public static void main(String[] args) {
		Test_Classifier_Fw model = new Test_Classifier_Fw();
		model.resetZ3();
