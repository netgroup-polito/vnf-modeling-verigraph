...
import it.polito.verigraph.mcnet.netobjs2.Rule_GlobalDnsBalancer;
import it.polito.verigraph.mcnet.netobjs2.Rule_SipServer;
import it.polito.verigraph.mcnet.netobjs2.Rule_UAForTest;
...
public class Test_SIP2 {
    ...
    public  Test_SIP2(){
        ...
        rt6.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_sipB"),sipB));
        ...
        //installUA(Expr domain1, Expr ip_caller, Expr ip_sipServer, Expr num, Expr domain, Expr num_receiver)
        a.installUA(ctx.mkInt(3), nctx.am.get("ip_a"), nctx.am.get("ip_sipA"), ctx.mkInt(1), ctx.mkInt(4), ctx.mkInt(2));	  //a-->b
        b.installUA(ctx.mkInt(4), nctx.am.get("ip_b"), nctx.am.get("ip_sipB"), ctx.mkInt(2), ctx.mkInt(3), ctx.mkInt(1));	  //b-->a
        c.installUA(ctx.mkInt(3), nctx.am.get("ip_c"), nctx.am.get("ip_sipA"), ctx.mkInt(5), ctx.mkInt(3), ctx.mkInt(1));  //c-->a
