...
import it.polito.verigraph.mcnet.netobjs2.Rule_IPv4Access;
import it.polito.verigraph.mcnet.netobjs2.Rule_IPv4Exit;
/**
 * <p/>
 * VPN test													<p/>
 *| a | --------- | access | --------- | exit |	--------- | b |	<p/>
...
public class Test_IpV4inV6_V6subNet {
    ...
    {
    	Test_IpV4inV6_V6subNet model = new Test_IpV4inV6_V6subNet();
        model.resetZ3();
