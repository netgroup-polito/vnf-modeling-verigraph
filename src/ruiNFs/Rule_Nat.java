	...
	public void installNat(Expr natIp, Expr new_port) {
		...
		constraints.add(ctx
				.mkForall(
						new Expr[] { p_0,
								n_0 },
						ctx.mkImplies(
								ctx.mkAnd((BoolExpr) nctx.send.apply(n_Nat, n_0, p_0),
								...
								ctx.mkExists(new Expr[] { p_1, n_1 }, ctx.mkAnd(
										(BoolExpr) nctx.recv.apply(n_1, n_Nat, p_1),
										(BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_1)),
										ctx.mkExists(new Expr[] { p_2, n_2 },
												ctx.mkAnd((BoolExpr) nctx.recv.apply(n_2, n_Nat, p_2),
		...
		constraints.add(ctx
				.mkForall(
						...
						ctx.mkImplies(
								ctx.mkAnd(
										(BoolExpr) nctx.send.apply(n_Nat, n_0,
												p_0),
										ctx.mkNot((BoolExpr) isInternal.apply(nctx.pf.get("dest").apply(p_0))),
										ctx.mkEq(nctx.pf.get("src").apply(p_0), natIp),
										ctx.mkEq(nctx.src_port.apply(p_0), new_port)),
								ctx.mkExists(new Expr[] { p_1, n_1 }, ctx.mkAnd(
										(BoolExpr) nctx.recv.apply(n_1, n_Nat, p_1),
										(BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_1)),
										ctx.mkNot(ctx.mkExists(new Expr[] { p_2, n_2 },
												ctx.mkAnd((BoolExpr) nctx.recv.apply(n_2, n_Nat, p_2),
														(BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_2)),
														ctx.mkEq(nctx.pf.get("src").apply(p_1),
																nctx.pf.get("src").apply(p_2)),
		...
		constraints.add(ctx.mkForall(new Expr[] { p_0, n_0 }, ctx.mkImplies(
				...
				ctx.mkExists(new Expr[] { p_1, n_1 },
						ctx.mkAnd((BoolExpr) nctx.recv.apply(n_1, n_Nat, p_1),
								ctx.mkNot((BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_1))), ctx.mkExists(
										new Expr[] { p_2, n_2 }, ctx.mkAnd((BoolExpr) nctx.recv.apply(n_2, n_Nat, p_2),
												(BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_2)),
