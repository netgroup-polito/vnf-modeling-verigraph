...
public class Rule_IdsTest {
	...
	//	client = new PolitoWebClient(ctx, new Object[]{nctx.nm.get("client"), net, nctx, nctx.am.get("ip_webServer")});
	    ...
	    rtClient.add(new Tuple<>(nctx.am.get("ip_webServer"), ids));
	...
	public static void main(String[] args) throws Z3Exception
    {
    	...
    	Rule_IdsTest model = new Rule_IdsTest();
    	model.resetZ3();
