...
class SymRule_Antispam {
  ...
  public InstructionBlock[] addrule(  String[][] p){
    ...
    for (int i=0; i < p.length(); i++) {
      rule=Array(InstructionBlock(If(Constrain(Tag("EMAIL_FROM"),ConstantValue(p(i + 0))),Fail("Match"),NoOp)));
