...
class SymRule_Classifier {
  ...
  public InstructionBlock[] addrule(  String[][] p){
    ...
    for (int i=0; i < p.length(); i++) {
      rule=Array(InstructionBlock(If(Constrain(Tag("PROTO"),ConstantValue(p(i + 0))),Fail("Dropped"),NoOp)));
