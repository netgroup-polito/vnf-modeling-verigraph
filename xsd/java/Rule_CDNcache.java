	...
	public void installCDNcache() {
		...
		constraints.add(ctx.mkForall(
				new Expr[] { p_0,
						n_0 },
				ctx.mkImplies(
						ctx.mkAnd((BoolExpr) nctx.send.apply(n_CDNcache, n_0, p_0),
						...
						ctx.mkExists(
								new Expr[] { p_1,
										n_1 },
								ctx.mkAnd((BoolExpr) nctx.recv.apply(n_1, n_CDNcache, p_1),
										(BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_1)),
										ctx.mkEq(nctx.pf.get("proto").apply(p_1), ctx.mkInt(nctx.HTTP_REQUEST)),
										ctx.mkExists(new Expr[] { p_2, n_2 }, ctx.mkAnd(
												(BoolExpr) nctx.recv.apply(n_2, n_CDNcache, p_2),
												ctx.mkNot((BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_2))),
												ctx.mkEq(nctx.pf.get("url").apply(p_1), nctx.pf.get("url").apply(p_2))),
												1, null, null, null, null),
										ctx.mkEq(nctx.pf.get("dest").apply(p_0), nctx.pf.get("src").apply(p_1)),
										ctx.mkEq(nctx.pf.get("src").apply(p_0), nctx.pf.get("oldDest").apply(p_1)),
										ctx.mkEq(nctx.pf.get("oldDest").apply(p_0), nctx.pf.get("dest").apply(p_1)),
		...
		constraints
				.add(ctx.mkForall(
						new Expr[] { p_0, n_0 }, ctx
								.mkImplies(
										ctx.mkAnd(
												(BoolExpr) nctx.send.apply(n_CDNcache, n_0, p_0), ctx
										...
										ctx.mkExists(new Expr[] { p_1, n_1 }, ctx.mkAnd(
												(BoolExpr) nctx.recv.apply(n_1, n_CDNcache, p_1),
												(BoolExpr) isInternal.apply(nctx.pf.get("src").apply(p_1)),
												ctx.mkEq(nctx.pf.get("proto").apply(p_1), ctx.mkInt(nctx.HTTP_REQUEST)),
												ctx.mkNot(ctx.mkExists(new Expr[] { p_2, n_2 },
														ctx.mkAnd((BoolExpr) nctx.recv.apply(n_2, n_CDNcache, p_2),
																ctx.mkNot((BoolExpr) isInternal
																		.apply(nctx.pf.get("src").apply(p_2))),
																ctx.mkEq(nctx.pf.get("url").apply(p_1),
						...
						1, null, null, null, null));
		constraints.add(ctx.mkForall(
				new Expr[] { p_0, n_0 }, ctx.mkImplies(
						ctx.mkAnd((BoolExpr) nctx.send.apply(n_CDNcache, n_0, p_0),
								(BoolExpr) isInternal.apply(nctx.pf.get("dest").apply(p_0)),
								ctx.mkEq(nctx.pf.get("proto").apply(p_1), ctx.mkInt(nctx.HTTP_RESPONSE))),
						ctx.mkExists(new Expr[] { p_1, n_1 }, ctx.mkAnd(
								(BoolExpr) nctx.recv.apply(n_1, n_CDNcache, p_1),
